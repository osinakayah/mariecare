        ...
        <div class="container">
            <div class="row">
                <div class="heading-title text-center">
                    ...
                    <p class="p-top-30 half-txt">Volunteering is the ultimate exercise in democracy.
                        You vote in elections once a year, but when you volunteer, you vote every day about the kind of community you want to live in</p>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="testimonial-cont">
                        ...
                        <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                            ...
                            <h4>Osinakayah Ifeanyi, <span>Volunteer</span></h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 offset-lg-2 col-lg-5">
                    <div class="testimonial-cont">
                        ...
                        <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                            ...
                            <h4>Rachel A.N, <span>Volunteer</span></h4>
                        </div>
                    </div>
                </div>
            </div>
